# ArchPillar.Extensions.Primitives.DependencyInjection

`Microsoft.Extensions.DependencyInjection` integration for `ArchPillar.Extensions.Primitives`. Adds a fluent `services.AddPipeline<T>()` registration for `Pipeline<T>` middlewares and handlers.
