...
/// <summary>
/// The translation formats the library ships with (XLIFF, ARB, PO), assembled into a fresh
/// <see cref="TranslationFormatRegistry"/>. This is the default format set; each call returns a new registry, so
/// support stays per-instance with no shared static state. Start from it to register a custom format.
/// </summary>
public static class BuiltInTranslationFormats
{
    /// <summary>Creates a registry with the built-in XLIFF, ARB, and PO formats registered.</summary>
