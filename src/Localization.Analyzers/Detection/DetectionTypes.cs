...
internal sealed record DetectionProblem(DetectionCause Cause, string? Detail, Location Location);
...
internal sealed record TranslationSiteResult(TranslationSite? Site, IReadOnlyList<DetectionProblem> Problems);
